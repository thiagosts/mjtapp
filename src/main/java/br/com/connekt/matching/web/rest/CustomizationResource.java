...
import br.com.connekt.matching.web.rest.errors.BadRequestAlertException;
import br.com.connekt.matching.web.rest.util.HeaderUtil;
import br.com.connekt.matching.web.rest.util.PaginationUtil;
...
public class CustomizationResource {
    ...
    private static final String ENTITY_NAME = "matchingJobCustomization";
