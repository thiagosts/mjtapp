package br.com.connekt.matching.config;
...
public class CacheConfiguration {
    ...
    public HazelcastInstance hazelcastInstance(JHipsterProperties jHipsterProperties) {
        ...
        HazelcastInstance hazelCastInstance = Hazelcast.getHazelcastInstanceByName("matchingJob");
        if (hazelCastInstance != null) {
            log.debug("Hazelcast already initialized");
            return hazelCastInstance;
        }
        Config config = new Config();
        config.setInstanceName("matchingJob");
        ...
        config.getMapConfigs().put("br.com.connekt.matching.domain.*", initializeDomainMapConfig(jHipsterProperties));
